...
class UniversalItemCard extends StatelessWidget {
  final String title;
  final String? subtitle; // e.g., "100 Qs • 200 Marks" or "PDF • 2 MB"
  final String? time; // Optional: "120 mins"
  final double price;
  final double? originalPrice;
  final String? discountTag;
  final String? coverUrl;
  final String actionLabel; // Default to 'View' if not provided
  ...
  Widget build(BuildContext context) {
    // Use compact layout for purchased items
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  // Trailing widget (e.g., delete button)
                  if (trailing != null)
                    Padding(
          ...
          child: SizedBox(
            ...
            child: Row(
              ...
              children: [
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                // Buy/Claim/View Button
                                SizedBox(
                                  height: 36,
                                  child: ElevatedButton(
                                    onPressed: isPurchased
                                        ? onTap // If purchased, open detail
                                        : (isActionEnabled
                                            ? onActionTap
                                            : null),
                                    style: ElevatedButton.styleFrom(
                ...
                // 3. Trailing widget (e.g., delete button)
                if (trailing != null)
                  Padding(
                    padding: const EdgeInsets.only(right: AppSpacing.sm),
                    child: trailing!,
