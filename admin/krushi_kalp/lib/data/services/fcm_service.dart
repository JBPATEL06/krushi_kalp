...
Future<void> _firebaseMessagingBackgroundHandler(RemoteMessage message) async {
  ...
  if (true) {
    ...
    // 2. Define High Importance Channel uniquely for Admin App
    const AndroidNotificationDetails androidDetails =
        AndroidNotificationDetails(
      'krushi_kalp_admin_channel',
      'Krushi Kalp Admin Notifications',
    ...
    // 3. Show Notification (Admin App Offset: +1 to prevent ID collision with user app)
...
class FCMService {
  ...
  Future<void> initialize() async {
    ...
    const AndroidNotificationChannel channel = AndroidNotificationChannel(
      'krushi_kalp_admin_channel', // id
      'Krushi Kalp Admin Notifications', // title
      description:
          'This channel is used for important admin notifications.', // description
