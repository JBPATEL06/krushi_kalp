...
class _AdminOfferListScreenState extends State<AdminOfferListScreen> {
  ...
  Future<void> _loadClaimCounts() async {
    final counts = await OfferService.getOfferClaimCounts();
    debugPrint("AdminOfferList: Loaded claim counts: $counts");
    if (mounted) {
      setState(() {
        _claimCounts = counts;
      });
                  ...
                  child: displayedOffers.isEmpty
                      ...
                      : ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final claims = _claimCounts[offer.id] ?? 0;
