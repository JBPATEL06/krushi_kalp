...
class _ScoreScreenState extends State<ScoreScreen> {
                            ...
                            child: DropdownButtonFormField<int?>(
                              ...
                              items: [
                                ...
                                ..._results
                                    ...
                                    .toSet()
                                    .map((id) {
                                  // Find first occurrence to get title
                                  final r = _results.firstWhere(
                                      (element) => element.testId == id);
                                  return DropdownMenuItem<int?>(
                                    value: id,
                                    child: Text(r.testTitle,
                          ...
                          child: RefreshIndicator(
                            ...
                            child: AnimationLimiter(
                              child: ListView.separated(
                                ...
                                itemCount: _selectedTestId == null
                                    ? _results.length
                                    : _results
                                        .where(
                                            (r) => r.testId == _selectedTestId)
                                        .length,
                                separatorBuilder: (_, __) =>
                                    const SizedBox(height: AppSpacing.md),
                                itemBuilder: (context, index) {
                                  final filteredList = _selectedTestId == null
                                      ? _results
                                      : _results
                                          .where((r) =>
                                              r.testId == _selectedTestId)
                                          .toList();
  ...
  void _deleteResult(int resultId) async {
    ...
    if (confirmed == true) {
      ...
      try {
        await TestService.deleteTestResult(resultId);

        // Re-fetch to ensure consistency (optional but good)
        await _loadData();
